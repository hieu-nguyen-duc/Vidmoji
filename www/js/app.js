...
angular.module('starter', ['ionic', 'starter.controllers', 'ngDisqusApi', 'starter.services'])

  .constant('HOST', 'https://cordialcode.com/app/api/ourpangea/api/')/* ajjenda base url */

.run(function($ionicPlatform, $state, $rootScope, HTTP, $ionicLoading) {
  $ionicPlatform.ready(function() {
    ...
    $rootScope.templates = [
      { name: 'footer-popup.html', url: 'templates/footer-popup.html'}
    ]

    $rootScope.template_footer = $rootScope.templates[0];
})

.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $disqusApiProvider) {
